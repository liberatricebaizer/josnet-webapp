const styles = {
  ...
  heading:
    "text-[27px] text-center lg:text-start font-[600] font-Roboto pb-[20px]",
  ...
  input: "w-full border bg-slate-100 p-1 border-[#f63b60] rounded-[5px]",
  inputSecond: "w-full border bg-white p-1  rounded-[5px]",
  activeStatus:
